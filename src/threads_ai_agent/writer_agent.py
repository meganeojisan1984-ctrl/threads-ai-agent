...
class WriterAgent:
    ...
    def _build_prompt(self, topics: list[Topic]) -> str:
        ...
        return (
            ...
            "投稿全体は、読者の悩み → 失敗原因 → 具体行動 → プロフ誘導の順にしてください。"
            "特にトレンド投稿は「AIニュースを毎日追ってるのに、副業収益が増えない人は多いです」のように痛みから始めてください。"
            "失敗原因は「新機能を知ること」と「収益につながる作業に使うこと」は別、という構造で書いてください。"
            "具体行動は、記事ネタを10個出す、見出しを作る、比較表を作る、Threads投稿に変換する、のように箇条書きを優先してください。"
            "最後のpartには「僕が実際に使っているAI副業の始め方と、ブログ収益につなげる流れはプロフィールのブログにまとめています」のような収益導線を入れてください。"
            "URLを本文に直接貼るのは、cta_styleがdirect_urlの場合だけにしてください。通常はprofileにしてください。"
            "誇大表現、断定的な収益保証、煽りを避けてください。"
            "禁止表現: 解説しています、紹介しています、ぜひチェック、最新技術を生かすことで、興味がある方、効率アップ、チャンスが広がる、鍵、活用手順、掲載しています、確認いただければ幸いです、おすすめしたい、爆速、落とし穴があった、差がつく、本質、近道、マッチします、ブログで書いています。"
            "各partは220〜320文字を目安にしてください。最後のpartだけ160〜240文字でも構いません。"
            "各partは最低3文にしてください。2行だけの返信は禁止です。"
            "1投稿だけ読んでも意味が通るように、各partに主張・理由・具体例のうち最低2つを入れてください。"
            "ただ長くするのではなく、保存したくなる価値を入れてください。例: 手順、判断基準、失敗例、チェックリスト。"
